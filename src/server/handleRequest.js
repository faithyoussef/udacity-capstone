...
const _handleWeatherForecastRequest = handleWeatherForecastRequest;
export { _handleWeatherForecastRequest as handleWeatherForecastRequest };
const _handleCoordinatesRequest = handleCoordinatesRequest;
export { _handleCoordinatesRequest as handleCoordinatesRequest };
const _handleImageRequest = handleImageRequest;
export { _handleImageRequest as handleImageRequest };